Array: Array ek Data Structure hota hai jiska use ek se jyada items ko store krane ke lie kia jata hai. Array me kisi b type ka data store kraya ja skta hai. Array me sare element contigous (memory me pas pas) memory block me save hote hain.
...
Looping Array: Array ka nature iterable type ka hota hain. iska matlab yeh hain ki array par loop chlaya ja skta hain. yadi arrya par hum for loop, while loop, do while loop ka use karte hain to 0 se lekar array ki length se 1 kam tak loop chla skte hain. array par hum for of loop b chla skte hain. 
...
push(): push array function se array के end me एक या एक से ज्यादा elements को जोड़ा जाता है और उसके बाद array की length return करता है |
...
pop(): pop() array method में array के last element को array से remove करके return किया जाता है |
...
unshift(): unshift() method से array ki starting में एक या एक से ज्यादा element(s) को add किया जाता है और नए array की length को return किया जाता है |
...
shift(): shift() array method में array के शुरुआत के element को remove किया जाता है |
...
toString(): toString() array method से array को string में convert किया जाता है |
...
join(): join() array method में दिए हुए seperator से हर element को seperate किया जाता है |
...
concat(): concat() array method में एक या एक से ज्यादा arrays को जोड़ा जाता है |
...
splice(): splice() array method में array में elements add(s) या remove(s) किये जाते है और removed किये गए element को return करता है |
...
slice(): slice() array method में start और end index से नए array को return किया जाता है |
...
sort(): sort() array method में alphabet और numeric array को sort किया जाता है | sort() method ख़ास string array के लिए बनाया गया है |
...
reverse(): reverse() array method में दिए हुए array के elements को reverse किया जाता है |
...
forEach(): forEach() array method में हर एक array element के लिए function execute किया जाता है |
...
map(): map function , एक callback function या arrow function accept करता है , callback function में value और index number दोनों मिलते हैं जबकि arrow function में सिर्फ value मिलती है।
...
filter(): filter() array method में दिए हुए function से हर एक array के element को check करके उनका array return करता है | अगर array में से एक भी element function के statement के विरुद्ध होता है तो उस array के element को remove किया जाता है |
...
find(): find() array method में दिए हुए function के statement से related अगर कोई पहला index find होता है तो उसकी value return होती है |
...
findIndex(): findIndex() array में दिए हुए function के statement से related अगर कोई पहला index find होता है तो उसकी index return होती है |
...
some(): some() array method में अगर एक भी element function के statement से related हो तो ये 'true' return करता है | अगर function के statement से related नहीं होता तो 'false' return होता है |
...
every(): every() array method से दिए हुए function से हर एक array के element को check करके boolean value return करता है | अगर array में से एक भी element function के statement के विरुद्ध होता है तो 'false' value return होती है |
...
reduce(): reduce() function array ke sare elements ko iterate krta hai aur ek single value return krta hai. reduce() function 2 arguments leta hai :
  1. callback function
  2. initial value (ise accumulator b kha jata hai )
...
reduce() function ka use array ko ek object bnane ya kisi other type ka data structure bnane me kia ja skta hai. Iske lie hume ek accumulator object dena hoga and callback function us object ko each iteration me update krega
...
reduce() function me yadi initial value ni di gyi hai to array ka first element ko initial value mana jayega. Is case accumulator first value hoga and current value second value hogi. 
...
flat(): flat() function yadi array ke inside array hai to unko ek single one dimensional array bnane ke kaam aata hai. flat() ek optional parameter number leta hai jaise b depth b khte hai jo ye decide krta hai ki Array kitni depth tak merge hoke ek single array bnega. 
...
flatMap() us condition me useful hai jha array ke andar nested arrays ho. Kuki hm single step me hi array ko flat and map dono kr skte hai.