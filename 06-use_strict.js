...
/*To active the strict mode you need to add the "use strict" string expression right at
...
//What is use strict ?
//      by defult javascriot non strict way ma run hota hai.iska mtlb yaha hai ki
//javascript non strict mood ma kuch error ko ignore kar ta hai.for example:
x = 10;
console.log(x);
